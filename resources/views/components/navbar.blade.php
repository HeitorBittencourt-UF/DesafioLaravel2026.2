            ...
            <li>
                <x-dropdown align="left" width="48">
                    <x-slot name="trigger">
                        <button
                            type="button"
                            class="flex items-center gap-2 whitespace-nowrap transition hover:text-green-400"
                        >
                    ...
                    <x-slot name="content">
                        ...
                        @forelse ($categorias as $categoria)
                            <x-dropdown-link
                                ...
                                :class="(string) request('categoria') === (string) $categoria->id
        ...
        <div class="navbar-icons">
            ...
            @else
                ...
                @if (Route::has('register'))
                    <a
                        href="{{ route('register') }}"
                        class="nav-auth-link nav-auth-link-register"
                    >
                        Cadastrar
                    </a>
                @endif
