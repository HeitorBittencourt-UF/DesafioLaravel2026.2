<section class="profile-section" aria-labelledby="profile-password-title">
    <header class="profile-card-header">
        <div class="profile-card-icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M16.5 10.5V6.75a4.5 4.5 0 00-9 0v3.75m-.75 0h10.5A2.25 2.25 0 0119.5 12.75v6A2.25 2.25 0 0117.25 21H6.75a2.25 2.25 0 01-2.25-2.25v-6a2.25 2.25 0 012.25-2.25z" />
            </svg>
        </div>

        <div>
            <h2 id="profile-password-title" class="profile-card-title">SEGURANÇA</h2>
    ...
    <form method="post" action="{{ route('password.update') }}" class="profile-form">
        ...
        <div class="profile-form-actions">
            <button type="submit" class="profile-primary-button">Atualizar senha</button>
