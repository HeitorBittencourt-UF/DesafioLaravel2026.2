<x-app-layout>
    @php
        ...
        $accountType = ($user->tipo ?? 'usuario') === 'administrador' ? 'Administrador' : 'Cliente';
    @endphp
        ...
        <main class="profile-shell">
            ...
            <section class="profile-summary" aria-label="Resumo da conta">
                ...
                <div class="profile-summary-info">
                    <span class="profile-summary-label">CONTA HYPESTORE</span>
                    <h2>{{ $displayName }}</h2>
                    <p>{{ $user->email }}</p>
                </div>

                <div class="profile-account-badges">
                    <span class="profile-account-type">{{ $accountType }}</span>
